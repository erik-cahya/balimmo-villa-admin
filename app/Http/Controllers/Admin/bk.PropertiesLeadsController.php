...
class PropertiesLeadsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->role == 'Master') {
            ...
            //      ->where('properties_id', '!=', null)->where('prospect_status', 0)
            //     ->select(
            //         'property_leads.*',
            ...
            // $data['data_leads'] = CustomerDataModel::where('agent_code', '!=', null)
            //     ->where('properties_id', '!=', null)->where('prospect_status', 0)
            ...
            $data['data_leads'] = PropertyLeadsModel::join('customer_data', 'customer_data.id', '=', 'property_leads.customer_id')
                ->join('properties', 'properties.id', '=', 'property_leads.properties_id')
                ->get();
