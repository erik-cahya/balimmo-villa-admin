    ...
    public function edit($slug)
    {
        $data['data_properties'] = PropertiesModel::where('property_slug', $slug)
            ...
            ->select(
                ...
                // Agent
                'property_financial.find_property_of',
                'property_financial.agent_name',
                'property_financial.agent_email',
                'property_financial.agent_phone',

                // Price Structure
                'property_financial.base_price_option',
                'property_financial.base_price',
                'property_financial.desired_price_idr',
                ...
                'property_legal.deadline_payment',
                'property_legal.zoning',
                'property_legal.construction_quality',
                'property_legal.consturctor_name',
            )
            ->first();
