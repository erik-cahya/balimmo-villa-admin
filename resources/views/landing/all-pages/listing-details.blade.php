...
<head>
  <meta charset="utf-8">
  <title>NewVilla - Listing Details</title>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                              <div class=" listing__hero--slider__items position-relative">
                                <img class="listing__hero--slider__media" src="./assets/img/hero/listing-details-hero.jpg" alt="img">
                                ...
                                <div class="listing__details--content__step mb-80">
                                    ...
                                    <div class="apartment__info listing__d--info">
                                        <div class="apartment__info--wrapper d-flex">
                                            ...
                                            <div class="apartment__info--list">
                                                <span class="apartment__info--icon"><img src="./assets/img/icon/bathroom.png" alt="img"></span>
                                                <p>
                                                    <span class="apartment__info--count">3</span>
                                    ...
                                    <div class="chat__profile--step">                                     
                                        <ul class="chat__profile--photos d-flex" style="gap: 1rem; margin-bottom: .5rem;">
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img2.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img2.jpg" alt="img"></a>
                                            </li>
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img3.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img3.jpg" alt="img"></a>
                                            </li>
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img4.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img4.jpg" alt="img"></a>
                                            </li>
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img5.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img5.jpg" alt="img"></a>
                                            </li>
                                        </ul>
                                        <ul class="chat__profile--photos d-flex" style="gap: 1rem;">
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img6.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img6.jpg" alt="img"></a>
                                            </li>
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img7.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img7.jpg" alt="img"></a>
                                            </li>
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img8.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img8.jpg" alt="img"></a>
                                            </li>
                                            <li class="chat__profile--photos__items">
                                                <a class="chat__profile--photos__link glightbox" href="./assets/img/hero/img9.jpg" data-gallery="gallery"><img class="chat__profile--photos__media" src="./assets/img/hero/img9.jpg" alt="img"></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="agents__consult--inner position-relative">
                    ...
                    <div class="agents__consult--thumb">
                        <img src="./assets/img/other/agents-thumb.png" alt="img">
                    </div>
                </div>
            </div>
        </section>
                                ...
                                <div class="footer__widget--inner">
                                    <div class="footer__logo">
                                        <a class="footer__logo--link display-block" href="index.html">
                                            <img class="footer__logo--img" src="assets/img/logo/nav-log-white.png" width="200px" alt="logo-img">
                                        </a>
                                    </div>
