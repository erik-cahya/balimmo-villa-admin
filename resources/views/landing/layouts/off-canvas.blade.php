...
<div class="offcanvas side__menu offcanvas-start" tabindex="-1" id="offcanvasExample">
    <div class="side__menu--header d-flex align-items-center justify-content-between">
        <h2 class="side__menu--title">Welcome to Balimmo</h2>
        ...
        <div class="sidebar__gallery">
            ...
            <ul class="sidebar__gallery--wrapper d-flex">
                <li class="sidebar__gallery--items">
                    <a class="sidebar__gallery--link" href="./listing.html"><img class="sidebar__gallery--img" src="{{ asset('landing') }}/assets/img/gallery/gallery1.png" alt="gallery"></a>
                    <span class="sidebar__gallery--subtitle">Villa</span>
                </li>
                <li class="sidebar__gallery--items">
                    <a class="sidebar__gallery--link" href="./listing.html"><img class="sidebar__gallery--img" src="{{ asset('landing') }}/assets/img/gallery/gallery3.png" alt="gallery"></a>
                    <span class="sidebar__gallery--subtitle">Apartment</span>
                </li>
                <li class="sidebar__gallery--items">
                    <a class="sidebar__gallery--link" href="./listing.html"><img class="sidebar__gallery--img" src="{{ asset('landing') }}/assets/img/gallery/gallery2.png" alt="gallery"></a>
                    <span class="sidebar__gallery--subtitle">Complex Villa</span>
                </li>
                <li class="sidebar__gallery--items">
                    <a class="sidebar__gallery--link" href="./listing.html"><img class="sidebar__gallery--img" src="{{ asset('landing') }}/assets/img/gallery/gallery4.png" alt="gallery"></a>
                    <span class="sidebar__gallery--subtitle">Land</span>
                </li>
        ...
        <div class="side__menu--footer">
            <div class="side__menu--info">
                <div class="side__menu--info__list">
                    ...
                    <p><a class="side__menu--info__text" href="tel:+6285333777500">(+62) 85 333 777 500</a></p>
                </div>
                <div class="side__menu--info__list">
            ...
            <div class="side__menu--share d-flex align-items-center">
                ...
                <ul class="side__menu--share__wrapper d-flex align-items-center">
                    <li class="side__menu--share__list">
                        <a class="side__menu--share__icon" target="_blank" href="https://www.facebook.com/people/Balimmo/61557243686168/">
                    ...
                    <li class="side__menu--share__list">
                        <a class="side__menu--share__icon" target="_blank" href="https://www.instagram.com/balimmo_villa/?igsh=MXJhY2xkMXBnaGplbA%3D%3D#">
                    ...
                    <li class="side__menu--share__list">
                        <a class="side__menu--share__icon" target="_blank" href="https://www.tiktok.com/@balimmo?_t=8losSwiYXXW&_r=1">
                    ...
                    <li class="side__menu--share__list">
                        <a class="side__menu--share__icon" target="_blank" href="https://www.youtube.com/@Balimmo_villa">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="offcanvas__inner">
        <div class="offcanvas__logo">
            <a class="offcanvas__logo_link" href="./index.html">
                <img src="{{ asset('landing') }}/assets/img/logo/nav-logo.png" alt="Logo-img" width="158" height="36">
            </a>
        ...
        <nav class="offcanvas__menu">
            <ul class="offcanvas__menu_ul">
                <li class="offcanvas__menu_li">
                    <a class="offcanvas__menu_item" href="{{ route('landing-page.index') }}">Home</a>
        ...
        <a class="add__listing--btn offcanvas__listing--btn solid__btn" href="{{ route('landing-page.contact') }}"><span>Contact Us</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
