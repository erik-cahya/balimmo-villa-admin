                        ...
                        <div class="listing__widget">
                            <div class="widget__search mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                                <div class="widget__search--input position-relative">
                                    ...
                                    {{-- <input type="text" id="search_props" class="form-control" placeholder="Search property..."> --}}
                                ...
                                <div class="widget__list mb-0">
                                    ...
                                    <ul class="widget__location">
                                        <li class="widget__location--list">
                                            <label class="widget__location--label" for="check8">Canggu</label>
                                            <input class="widget__catagories--input" id="check8" type="checkbox" name="location[]" value="Canggu">
                                            <span class="widget__catagories--checkmark"></span>
                                        </li>
                                        <li class="widget__location--list">
                                            <label class="widget__location--label" for="check9">Nyanyi</label>
                                            <input class="widget__catagories--input" id="check9" type="checkbox" name="location[]" value="Nyanyi">
                                            <span class="widget__catagories--checkmark"></span>
                                        </li>
                                        <li class="widget__location--list">
                                            <label class="widget__location--label" for="check10">Cemagi </label>
                                            <input class="widget__catagories--input" id="check10" type="checkbox" name="location[]" value="Cemagi">
                                            <span class="widget__catagories--checkmark"></span>
                                        </li>
                                        <li class="widget__location--list">
                                            <label class="widget__location--label" for="check11">Gianyar</label>
                                            <input class="widget__catagories--input" id="check11" type="checkbox" name="location[]" value="Gianyar">
                                            <span class="widget__catagories--checkmark"></span>
                                        </li>
                                    </ul>
                                </div>
