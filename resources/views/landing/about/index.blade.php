                ...
                <div class="about__content--info d-flex">
                    <div class="about__content--info__list d-flex align-items-center">
                        <div class="about__content--info__icon">
                            <img src="{{ asset('landing') }}/assets/img/other/about-info-icon.png" alt="icon">
                        </div>
                    ...
                    <div class="about__content--info__list d-flex align-items-center">
                        <div class="about__content--info__icon">
                            <img src="{{ asset('landing') }}/assets/img/other/about-info-icon2.png" alt="icon">
                        </div>
    ...
    <div class="container">
        ...
        <div class="categories__inner row mb--n30">
            <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                <div class="categories__box">
                    <div class="categories__thumbnail text-center">
                        <img src="{{ asset('landing') }}/assets/img/other/categories1.png" alt="categories-img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                <div class="categories__box">
                    <div class="categories__thumbnail text-center">
                        <img src="{{ asset('landing') }}/assets/img/other/categories2.png" alt="categories-img">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                <div class="categories__box">
                    <div class="categories__thumbnail text-center">
                        <img src="{{ asset('landing') }}/assets/img/other/categories3.png" alt="categories-img">
                    </div>
            ...
            <div class="popular__featured--column5 swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties3.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties4.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties5.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
