            ...
            <div class="popular__featured--column5 swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties1.png" alt="popular-properties"></a>
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties2.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties-sanur.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties-nusapenida.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties-ubud.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
                    ...
                    <div class="swiper-slide">
                        <article class="popular__featured--card">
                            <div class="popular__featured--thumbnail position-relative">
                                <a class="popular__featured--link"  href="listing-details.html"><img class="popular__featured--img" src="{{ asset('landing') }}/assets/img/property/popular-properties-lovina.png" alt="popular-properties"></a>
                                <span class="popular__featured--badge">13</span>
                                <div class="popular__featured--content">
