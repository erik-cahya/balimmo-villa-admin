                                    ...
                                    <div class="featured__content--footer d-flex align-items-center justify-content-between">
                                        <div class="featured__author d-flex align-items-center">
                                            <span class="featured__author--img position-relative">
                                                <img src="{{ asset('landing') }}/assets/img/property/properties-author.png" alt="img">
                                            </span>
                                            <span class="featured__author--name">{{ $property->agent_name }}</span>
                                        </div>
                ...
                <form action="#">
                    ...
                    <div class="contact__property--form__inner">
                        ...
                        <div class="contact__property--form__input">
                            ...
                            <input id="number" placeholder="Enter your number" type="tel">
                        </div>
                        <div class="contact__property--form__input">
                        ...
                        <div class="contact__property--form__input">
                            ...
                            <input id="timing" placeholder="Timing" type="text">
                        </div>
                        <div class="contact__property--form__input">
