                                    ...
                                    <div class="featured__content--footer d-flex align-items-center justify-content-between">
                                        <div class="featured__author d-flex align-items-center">
                                            <span class="featured__author--img position-relative">
                                                ...
                                                <img src="{{ asset('admin') }}{{ $property->profilePicture == null ? '/assets/images/users/avatar-1.jpg' : '/profile-image/' . $property->referenceCode . '/' . $property->profilePicture }}" alt="img" style="object-fit: fill" class="rounded-circle" width="40">
                                            </span>
