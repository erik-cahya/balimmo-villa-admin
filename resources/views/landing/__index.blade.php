...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#budget_currency').on('change', function() {
                ...
                if ($(this).val() === 'usd') {
                    $('#budget_usd').attr('style', 'display: block !important');
                    $('#budget_idr').attr('style', 'display: none !important');
                } else {
                    $('#budget_usd').attr('style', 'display: none !important');
                    $('#budget_idr').attr('style', 'display: block !important');
                }
            });

            // $('#number_bedroom').hide();
            // $('#number_land_size').hide();
            // // Saat user mengganti pilihan
            // $('#type_asset').on('change', function() {

            //     if ($(this).val() === 'villa') {
            //         $('#number_bedroom').attr('style', 'display: block !important');
            //         $('#number_land_size').attr('style', 'display: none !important');
            //     } else {
            //         $('#number_bedroom').attr('style', 'display: none !important');
            //         $('#number_land_size').attr('style', 'display: block !important');
            //     }
            // });
    ...
    <script>
        function toggleSections() {
            const selected_villa = $('input[name="type_asset_villa"]:checked').val();
            const selected_land = $('input[name="type_asset_land"]:checked').val();
        ...
        $(document).ready(function() {
            ...
            $('input[name="type_asset_villa"]').on('change', toggleSections);
            $('input[name="type_asset_land"]').on('change', toggleSections);
        });
    </script>
    ...
    <script>
        const cleaveFields = [{
                id: '#minimum_budget_idr',
                options: {
                    prefix: 'IDR '
                }
            },
            {
                id: '#maximum_budget_idr',
                options: {
                    prefix: 'IDR '
                }
            },
            {
                id: '#maximum_budget_usd',
                options: {
                    numeral: true,
