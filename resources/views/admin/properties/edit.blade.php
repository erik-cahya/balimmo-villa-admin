            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="fw-semibold mb-0">Edit Villa</h4>
                                ...
                                <div class="col-12 row bg-light-subtle border-dark gap-4 rounded border p-3">
                                    ...
                                    <div class="col-6 row" id="rentalDataFields" style="display: none">
                                        ...
                                        <div class="col-12 mb-1">
                                            ...
                                            value="{{ old('average_price', $data_properties->average_price) }}"/>
                                        </div>
                                        ...
                                        <div class="col-12 mb-1" id="occupancyRateField" style="display: none;">
                                            ...
                                            value="{{ old('average_occupancy_rate', $data_properties->average_occupancy_rate) }}"/>
                                        ...
                                        <div class="col-12 mb-1">
                                            ...
                                            value="{{ old('annual_turnover', $data_properties->annual_turnover) }}"/>
                                        </div>
...
<script>
    ...
    <script>
        ...
        function initializeForm() {
            // Check if there's a selected radio button and update accordingly
            const checkedRadio = document.querySelector('input[name="average_price_option"]:checked');
            if (checkedRadio) {
                updateLabel(checkedRadio.value);
            }
            
            // Format existing average_price value if it exists
            if (averagePriceInput.value) {
                formatNumberInput(averagePriceInput);
            }
            
            // Calculate annual turnover with existing values
        ...
        occupancyRateInput.addEventListener('input', function() {
            // Validate occupancy rate input (0-100%) - only for this field
