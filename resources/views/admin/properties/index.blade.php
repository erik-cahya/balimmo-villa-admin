                            ...
                            <tbody>
                                @foreach ($data_property as $property)
                                    <tr>
                                        ...
                                        <td data-href="{{ route('properties.details', $property->property_slug) }}" style="cursor: pointer;">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h5 class="text-dark fw-medium mb-0 capitalize">{{ $property->property_name }}</h5>
                                        ...
                                        <td data-href="{{ route('properties.details', $property->property_slug) }}" style="cursor: pointer;"><span class="badge text-capitalize bg-primary-subtle text-primary fs-12 px-2 py-1">{{ $property->type_mandate }}</span></td>
