              ...
              <div class="card">
                   <div class="card-body">
                        <div class="position-relative">
                             <img src="{{ asset('admin') }}/assets/images/properties/p-11.jpg" alt="" class="img-fluid rounded">
                        ...
                        <div class="d-flex flex-wrap justify-content-between my-3 gap-2">
                             <div>
                                  <a href="#!" class="fs-18 text-dark fw-medium">{{ $data_properties->property_name }}</a>
