                            ...
                            <div class="col-6 row bg-light-subtle border-dark rounded border p-3">
                                ...
                                <div class="row m-0 p-0">
                                    ...
                                    <div id="find_property_selection" style="display: none">
                                        ...
                                        <x-form-input className="col-12" type="text" name="agent_phone" label="Whatsapp of this agent" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="find_property_by_agent" style="display: none" class="col-6 row bg-light-subtle border-dark rounded border p-3">
                                ...
                                <div class="row m-0 p-0">
                                    <div class="col-12">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="base_price_agent" id="net_seller_price_agent" value="NET seller">
                                            <label class="form-check-label" for="net_seller_price_agent">NET seller</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="base_price_agent" id="selling_price_agent" value="Selling price">
                                            <label class="form-check-label" for="selling_price_agent">Selling price</label>
                                        </div>
                                    </div>

                                    <x-form-input className="col-12" type="text" name="desire_price_from_the_agent" label="Desire price from the owner" placeholder="Price in IDR" />

                                    <div class="col-12 mb-1">
                                        <label class="form-check-label" for="commission_of_the_agent">Commission of the agent</label>
                                        <br />
                                        <div class="d-flex align-items-center gap-2">
                                            <input type="number" id="commission_of_the_agent" name="commission_of_the_agent" class="form-control" placeholder="%">
                                    ...
                                    <div class="col-12 my-1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="give_balimmo_commision" id="commission_balimmo_yes" value="Yes">
                                            <label class="form-check-label" for="commission_balimmo_yes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="give_balimmo_commision" id="commission_balimmo_no" value="No">
                                            <label class="form-check-label" for="commission_balimmo_no">No</label>
                                        </div>
                                    </div>

                                    <div class="col-12 mb-1">
                                        <label class="form-check-label" for="balimmo_commission_agent">Balimmo commission</label>
                                        <br />
                                        <div class="d-flex align-items-center gap-2">
                                            <input type="number" id="balimmo_commission_agent" name="balimmo_commission_agent" class="form-control" placeholder="%">
                                            <label for="">AMMOUNT</label>
                                        </div>
                                    </div>

                                    <x-form-input className="col-12" type="number" name="website_price_agent" label="Website price" />
                                </div>
                            </div>
                            ...
                            <div id="find_property_by_owner" style="display: none" class="col-6 row bg-light-subtle border-dark rounded border p-3">
                                ...
                                <div class="row m-0 p-0">
                                    <div class="col-12">
                                        <label class="form-label me-3">Whats the base price ?</label>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="base_price_owner" id="net_seller_owner" value="NET seller">
                                            <label class="form-check-label" for="net_seller_owner">NET saler</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="base_price_owner" id="selling_price_owner" value="Selling price">
                                            <label class="form-check-label" for="selling_price_owner">Selling Price</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-1">
                                        <label class="form-check-label" for="balimmo_commission_owner">Balimmo commission</label>
                                        <br />
                                        <div class="d-flex align-items-center gap-2">
                                            <input type="number" id="balimmo_commission_owner" name="balimmo_commission_owner" class="form-control" placeholder="%">
                                            <label for="">AMMOUNT</label>
                                        </div>
                                    </div>

                                    <x-form-input className="col-12" type="number" name="website_price_owner" label="Website price" />
                                </div>
                            </div>
