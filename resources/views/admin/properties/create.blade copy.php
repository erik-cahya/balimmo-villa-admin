                         ...
                         <div class="row">
                              ...
                              <div class="pt-4 px-3 rounded bg-light-subtle border border-dark mb-4">
                                   ...
                                   <div class="my-3 row">
                                        ...
                                        <x-form-input className="col-lg-6" type="text" name="bathroom" label="First Name" />
                                        <x-form-input className="col-lg-6" type="text" name="bathroom" label="Last Name" />
                                        <x-form-input className="col-lg-6" type="number" name="bathroom" label="Phone Number" />
                                        <x-form-input className="col-lg-6" type="email" name="bathroom" label="Email" />
