                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                                    <div class="d-flex align-items-center gap-2 col-12">
                                        <h3 class="fw-medium text-capitalize mb-0">{{ $data_properties->land_name }}</h3>
                                        <!-- <div>
                                            @php
                                        ...
                                        <div class="dropdown">
                                            ...
                                            @if (Auth::user()->role === 'master')
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <a class="dropdown-item" href="{{ route('land.changeAcceptance', ['slug' => $data_properties->land_slug, 'status' => 'pending']) }}">Pending</a>
                                                    <a class="dropdown-item" href="{{ route('land.changeAcceptance', ['slug' => $data_properties->land_slug, 'status' => 'accept']) }}">Accept</a>
                                                </div>
                                            @endif
                                        </div>
                                        <div>
                                    ...
                                    <!-- @if (Auth::user()->role === 'Master')                                    
                                        <form method="POST" action="{{ route('properties.changeAcceptance', $data_properties->land_slug) }}" class="d-flex gap-2 align-items-center col-4">
                                            @csrf
                                ...
                                @foreach ($attachment as $key => $value)
                                    @if ($value->name !== 'url_virtual_tour' && $value->name !== 'url_lifestyle' && $value->name !== 'url_experience')
                                        @if ($value->path_attachment !== null)
                                            <a href="{{ asset('admin/attachment/' . $data_properties->land_slug . '/' . $value->path_attachment) }}" class="text-dark stretched-link d-flex bg-light-subtle align-items-center position-relative gap-1 rounded border p-2 text-start">
                ...
                <!-- @if (Auth::user()->role === 'Master')
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('properties.changeAcceptance', $data_properties->land_slug) }}" class="d-flex align-items-center flex-wrap">
                                    @csrf
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="bg-light-subtle rounded border border-dashed p-2 mb-3">
                                <div class="row align-items-center g-2 text-center">                                    
                                    ...
                                    <div class="col-lg-4 col-md-6 col-6 border-end">
                                        <p class="text-muted d-flex align-items-center justify-content-center mb-0 gap-1"><iconify-icon icon="solar:arrow-up-broken" class="fs-18 text-warning"></iconify-icon> {{ $data_properties->land_width }}m²
                                        </p>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-6 border-end">
                                        <p class="text-muted d-flex align-items-center justify-content-center mb-0 gap-1"><iconify-icon icon="solar:arrow-right-broken" class="fs-18 text-warning"></iconify-icon> {{ $data_properties->land_width }}m²
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex align-items-center" style="justify-content: space-between !important ">
                                <a href="{{ route('land.edit', $data_properties->land_slug) }}" type="submit" class="btn btn-primary col-4">Edit Land</a>
                                <div class="col-6 ">
