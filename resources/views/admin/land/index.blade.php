            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center border-bottom">
                        <div>
                            <h4 class="card-title mb-0">All Land List <span class="badge bg-danger ms-1">{{ $data_property->count() }} </span></h4>
                        </div>
                        <a href="{{ route('land.create') }}" class="btn btn-success width-md">Add Land</a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($data_property as $property)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-dark fw-medium fs-15">300 </span>
                                        </td>                                   
                                        <td>
                                            <div class="d-flex flex-column">
