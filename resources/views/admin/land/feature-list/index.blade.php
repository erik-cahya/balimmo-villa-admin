                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div>
                                                        <a href="#!" class="text-dark fw-medium">{{ $indoor->name }}</a>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-soft-danger btn-sm deleteButton" data-nama="{{ $indoor->name }}"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="fs-18 align-middle"></iconify-icon></button>
                                                    {{-- /. Delete Button --}}
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    @foreach ($feature_outdoor as $outdoor)
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div>
                                                        <a href="#!" class="text-dark fw-medium">{{ $outdoor->name }}</a>
                                                    </div>
                                                </div>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <button type="button" class="btn btn-soft-danger btn-sm deleteButton" data-nama="{{ $outdoor->name }}"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="fs-18 align-middle"></iconify-icon></button>
                                                    {{-- /. Delete Button --}}
                                                </div>
                                            </td>
                                        </tr>
