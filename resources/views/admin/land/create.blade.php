                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            <div class="accordion-body row d-flex align-items-start justify-content-between gap-4 px-4">
                                ...
                                <div class="col-6 row bg-light-subtle border-dark rounded border px-1 py-2">
                                    ...
                                    <x-form-input className="col-lg-4" type="text" name="land_size" label="Total Land Size (are)" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6" id="split_field_container" style="display: none;">
                                            <label for="split_land_value" class="form-label">Minimum split (are)</label>
                                            <input type="text" id="split_land_value" name="split_land_value" class="form-control" placeholder="Minimum split (are)"/>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    {{-- {-- PRICE CALCULTAION --} --}}
    <script>    function parseRupiah(value) {
