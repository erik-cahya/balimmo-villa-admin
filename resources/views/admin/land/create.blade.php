        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">Listing Land</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-header text-bg-primary" style="border-radius: 0px 0px 20px 0px">
                            <h4 class="card-title text-uppercase">Land Owners</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <x-form-input className="col-lg-12" type="text" name="property_name" label="Land Name" />
                                ...
                                <div class="col-lg-12 mb-3" id="group_property_address">
                                    <label for="property_address" class="form-label">Land Address</label>
                    ...
                    <div class="card">
                        <div class="card-header text-bg-primary" style="border-radius: 0px 0px 20px 0px">
                            <h4 class="card-title text-uppercase">Technical Details of The Land</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">

                                <x-form-input className="col-lg-12" type="text" name="land_size" label="Total Land Area (m²)" placeholder="Input Land Size" />
                    ...
                    {{-- -------------------------------------------------------------------------  --}}
                    {{-- Legal Status of the Land Section Form  --}}
                    {{-- -------------------------------------------------------------------------  --}}
                    <div class="card">
                        <div class="card-header text-bg-primary" style="border-radius: 0px 0px 20px 0px">
                            <h4 class="card-title text-uppercase">Legal Status of the Land</h4>
                        </div>
                        <div class="card-body">

                            <x-form-select className="col-lg-12" name="legal_category" label="Land Legal Category" :options="['Leasehold', 'Freehold']" />
