                    ...
                    <table class="table-hover table-centered table text-nowrap" id="myTable">
                        ...
                        <tbody>
                            ...
                            @foreach ($data_leads as $customer => $cst)
                                ...
                                <tr>
                                    <td data-bs-toggle="modal" data-bs-target="#seeProperties-{{ $customerData->id }}" class="cursor-pointer">{{ $loop->iteration }}</td>
                                    ...
                                    <td data-bs-toggle="modal" data-bs-target="#seeProperties-{{ $customerData->id }}" class="cursor-pointer">{{ $customerData->localization }}</td>
                                    <td data-bs-toggle="modal" data-bs-target="#seeProperties-{{ $customerData->id }}" class="cursor-pointer"> {{ \Carbon\Carbon::parse($customerData->date)->format('d F, Y') }}</td>
                                    <td data-bs-toggle="modal" data-bs-target="#seeProperties-{{ $customerData->id }}" class="cursor-pointer">
