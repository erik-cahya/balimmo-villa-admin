            ...
            $('.showDetailsSpecific').on('click', function() {
                ...
                $.get('/leads/' + customerID + '/get-specific-properties', function(response) {
                    ...
                    if (tablePropertiesHTML !== '' || tableLandHTML !== '') {
                        ...
                        $('.tableContentProperties_specificLeads-' + customerID).html(tablePropertiesHTML);
                        $(tablePropertiesID).DataTable();

                        if ($.fn.DataTable.isDataTable(tableLandID)) {
                            $(tableLandID).DataTable().destroy();
                        }
                        $('.tableContentLand_specificLeads-' + customerID).html(tableLandHTML);
